...
Object.send(:remove_const, :PlayIdeaToboganCompletoScriptBrazo5) if defined?(PlayIdeaToboganCompletoScriptBrazo5)

module PlayIdeaToboganCompletoScriptBrazo5
  extend self
  ...
  class PlacementTool
    ...
    def onLButtonDown(_flags, x, y, view)
      ...
      PlayIdeaToboganCompletoScriptBrazo5.build_assembly(@input_point.position, X_AXIS)
...
PlayIdeaToboganCompletoScriptBrazo5.start
