...
Object.send(:remove_const, :PlayIdeaToboganCompletoScriptHastaBrazo4Listo) if defined?(PlayIdeaToboganCompletoScriptHastaBrazo4Listo)

module PlayIdeaToboganCompletoScriptHastaBrazo4Listo
  extend self
  ...
  class PlacementTool
    ...
    def onLButtonDown(_flags, x, y, view)
      ...
      PlayIdeaToboganCompletoScriptHastaBrazo4Listo.build_assembly(@input_point.position, X_AXIS)
...
PlayIdeaToboganCompletoScriptHastaBrazo4Listo.start
